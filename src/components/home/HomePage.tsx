          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-lg">
            <div className="text-left max-w-2xl">
              ...
              <p className="font-body-lg text-body-lg text-on-surface-variant">
                Una wiki pública y personal sobre informática e ingeniería de
                software. Reúne conceptos, patrones y decisiones que uso como
                base para proyectos en los que trabajo.
              </p>
            </div>
            <a
